...
| Sobreviviencia y análisis por PCA |     Parte 1 : {{badge curso_2/sobrevivencia.ipynb }} <br />Parte 2: {{badge curso_2/pca.ipynb}}                          |  Parte 1 : {{badge curso_2/sobrevivencia_solution.ipynb }} <br />Parte 2: {{badge curso_2/pca_solution.ipynb}}                          |
